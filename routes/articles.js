...
import { create, getAll, edit, get, getId } from '../controllers/articles.js'
...
router.post('/', auth.jwt, admin, articleUpload, create) // 建立新的商品
router.get('/all', auth.jwt, admin, getAll) // 獲取所有商品的列表
router.patch('/:id', auth.jwt, admin, articleUpload, edit) // 根據商品 ID 編輯商品
